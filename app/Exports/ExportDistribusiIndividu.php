...
class ExportDistribusiIndividu implements FromCollection,WithHeadings,WithColumnFormatting,WithStyles,ShouldAutoSize
{
    /**
    ...
    */
    ...
    {
        $individus = DB::table('distribusi_individus')
        ...
        ->where('distribusi_individus.id_list', $this->id)
        ->get();
        foreach ($individus as $item) {
