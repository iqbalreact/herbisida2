...
class ExportDistribusiDiantar implements FromCollection,WithHeadings,WithColumnFormatting,WithStyles,ShouldAutoSize
{
    /**
    ...
    */
    ...
    {
        $diantars = DB::table('distribusi_diantars')
        ...
        ->where('distribusi_diantars.id_list', $this->id)
        ->get();
        foreach ($diantars as $item) {
